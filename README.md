...
This package implements the Cacoo api in Golang.
No recommended go version is specified for this package. But also, still better to use latest version of go if posssible.
